...
'''
                                                    if cntBlk == 0:
                                                        ...
                                                        if cntPEC > 0:
                                                            if cntfrm > 0:
                                                                ...
                                                                if psumrow < Len-2 and psumcol < Len-2:
                                                                    temp_RAMPEC_DatRd =Psum0[NumBlk-1][cntPEB][cntPEC-1][psumrow][psumcol]
                                                                    if temp_RAMPEC_DatRd < 0:
                                                                        temp_RAMPEC_DatRd = hex(temp_RAMPEC_DatRd & 0x3fffffff )
                                                                        RAMPEC_DatRd_PEL[psumrow][psumcol] = RAMPEC_DatRd_PEL[psumrow][psumcol] +((str(temp_RAMPEC_DatRd).lstrip('0x')).rstrip('L'));
                                                                ...
                                                                Psum2[cntBlk][cntPEB][cntPEC][psumrow][psumcol] = 0 + acc[psumrow][psumcol][0] + acc[psumrow][psumcol+1][1] + acc[psumrow][psumcol+2][2];
                                                                if psumrow < Len-2:
                                                                    RAMPEC_DatRd_PEL[psumrow][psumcol] = RAMPEC_DatRd_PEL[psumrow][psumcol] + ((str(0).lstrip('0x')).rstrip('L')).zfill(8);
                                                        else:
                                                            if psumrow < Len-2:
                                                                RAMPEC_DatRd_PEL[psumrow][psumcol] = RAMPEC_DatRd_PEL[psumrow][psumcol] + ((str(0).lstrip('0x')).rstrip('L')).zfill(8);
                                                            Psum2[cntBlk][cntPEB][cntPEC][psumrow][psumcol] = 0 + acc[psumrow][psumcol][0] + acc[psumrow][psumcol+1][1] + acc[psumrow][psumcol+2][2];
                                                        ...
                                                        if psumrow >= 2 :
                                                            ...
                                                            PECRAM_DatWr[psumrow-2][psumcol] = Psum0[cntBlk][cntPEB][cntPEC][psumrow-2][psumcol]

                                                        CNVOUT_Psum2[psumrow][psumcol] = Psum2[cntBlk][cntPEB][cntPEC][psumrow][psumcol]
                                                        CNVOUT_Psum1[psumrow][psumcol] = Psum1[cntBlk][cntPEB][cntPEC][psumrow][psumcol]
                                                    else :
                                                        # ACCumulate across channel
                                                        if psumrow < Len-2 and psumcol < Len-2:
                                                            temp_RAMPEC_DatRd =Psum0[cntBlk-1][cntPEB][cntPEC][psumrow][psumcol]
                                                            if temp_RAMPEC_DatRd < 0:
                                                                temp_RAMPEC_DatRd = hex(temp_RAMPEC_DatRd & 0x3fffffff )
                                                        ...
                                                        if psumrow >= 2 :  # 14rows
                                                            ...
                                                            #if psumrow >= 2 :  # 14rows
                                                    if psumrow >= 2 :
                                                            if PECRAM_DatWr[psumrow-2][psumcol] < 0:
                                                                 # PSUM_WIDTH = 30b
                                                                 temp_PECRAM_DatWr = hex(PECRAM_DatWr[psumrow-2][psumcol] & 0x3fffffff)
                                                                 PECRAM_DatWr_PEL[psumrow-2][psumcol] = PECRAM_DatWr_PEL[psumrow-2][psumcol] + ((str(temp_PECRAM_DatWr).lstrip('0x')).rstrip('L'));
                                                            else:
                                                                temp_PECRAM_DatWr = hex(PECRAM_DatWr[psumrow-2][psumcol] &0x3fffffff )
                                                                PECRAM_DatWr_PEL[psumrow-2][psumcol] = PECRAM_DatWr_PEL[psumrow-2][psumcol] + ((str(temp_PECRAM_DatWr).lstrip('0x')).rstrip('L')).zfill(8);
                                                    if CNVOUT_Psum2[psumrow][psumcol] < 0:
                                                        temp_CNVOUT_Psum2 = hex(CNVOUT_Psum2[psumrow] [psumcol]& 0x3fffffff)
                                                    ...
                                                    if CNVOUT_Psum1[psumrow][psumcol] < 0:
                                                        temp_CNVOUT_Psum1 = hex(CNVOUT_Psum1[psumrow] [psumcol]& 0x3fffffff)
                                                        CNVOUT_Psum1_PEL[psumrow][psumcol] = CNVOUT_Psum1_PEL[psumrow][psumcol] + ((str(temp_CNVOUT_Psum1).lstrip('0x')).rstrip('L'));
                                                    else:
                                                        temp_CNVOUT_Psum1 = hex(CNVOUT_Psum1[psumrow][psumcol] )
                                                        CNVOUT_Psum1_PEL[psumrow][psumcol] = CNVOUT_Psum1_PEL[psumrow][psumcol] + ((str(temp_CNVOUT_Psum1).lstrip('0x')).rstrip('L')).zfill(8);
                                                #print(CNVOUT_Psum0[psumrow])

                                                # transfer to hex firstly
                                                # All PEC: PEC0PEC1PEC2PEC3PEC4....

                                                #CNVOUT_Psum1_PEL[psumrow] = CNVOUT_Psum1_PEL[psumrow] + ((str(CNVOUT_Psum1[psumrow]).lstrip('0x')).rstrip('L')).zfill(92);
                                                #if psumrow >= 2:
                                                   # CNVOUT_Psum0_PEL[psumrow-2] = CNVOUT_Psum0_PEL[psumrow-2] + ((str(CNVOUT_Psum0[psumrow-2]).lstrip('0x')).rstrip('L')).zfill(92);
